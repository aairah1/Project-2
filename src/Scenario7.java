...
public class Scenario7 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jRadioButton1.isSelected()) { // if the first radio button is selected
            MainMenu.cases[6].verdict.setStudentVerdict(Verdict.ethical); // set the case 6 verdict to be ethical
            ...
            MainMenu.cases[6].verdict.setStudentVerdict(Verdict.unethical); // set the case 6 verdict to be unethical
