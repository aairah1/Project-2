 ...
 * @author 345730287
 */
public class Scenario3 extends javax.swing.JFrame { // scenario3 class extends the jframe

    /**
     * Creates new form Scenario3
     */
    public Scenario3() { // Scenario3 constructor
        ...
        jTextArea2.setWrapStyleWord(true); // make the wrap style true
            ...
            addWindowListener(new WindowAdapter() { // add Window Listener
                ...
                public void windowActivated(WindowEvent e) { // activate the window
                    jLabel2.setText(MainMenu.cases[2].getCaseTitle()); // set the text as the case title
                    jLabel4.setText(MainMenu.cases[2].getCategory());
                    jTextArea2.setText(MainMenu.cases[2].getCaseDescription()); // set the text as the case description
                } // close
            }); // close
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        MainMenu.cases[2].verdict.setCaseName(jLabel2.getText()); // set the case 2 array verdict case name as the text in jLabel2
        MainMenu.cases[2].verdict.setReason(jTextArea1.getText()); // set the case 2 array cerdict case reason as the text area
        if (jRadioButton1.isSelected()) { // if the first radio button is selected
            MainMenu.cases[2].verdict.setStudentVerdict(MainMenu.Sethical); // set the case 2 verdict to be ethical
            ...
            MainMenu.cases[2].verdict.setStudentVerdict(MainMenu.Sunethical); // set the case 2 verdict to be unethical
            MainMenu.unethical += 1; // increment the unethical counter by 1
        } // end the if statements 
        
        new Scenario4().setVisible(true); // make the next frame visible
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Scenario3().setVisible(true); // make this page visible
            }
        });
    }
