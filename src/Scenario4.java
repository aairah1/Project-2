...
public class Scenario4 extends javax.swing.JFrame {
        ...
        jTextArea2.setWrapStyleWord(true); // make the wrap style true
            ...
            addWindowListener(new WindowAdapter() { // add Window Listener
                ...
                public void windowActivated(WindowEvent e) { // activate the window
                    ...
                    jLabel4.setText(MainMenu.cases[3].getCategory()); // set the text as the case category
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jRadioButton1.isSelected()) { // if the first radio button is selected
            MainMenu.cases[3].verdict.setStudentVerdict(Verdict.ethical); // set the case 3 verdict to be ethical
            ...
            MainMenu.cases[3].verdict.setStudentVerdict(Verdict.unethical); // set the case 3 verdict to be unethical
