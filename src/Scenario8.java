...
public class Scenario8 extends javax.swing.JFrame {
     ...
     */
    public Scenario8() { // Scenario8 constructor
        ...
        jTextArea2.setWrapStyleWord(true); // make the wrap style true
            ...
            addWindowListener(new WindowAdapter() { // add Window Listener
                ...
                public void windowActivated(WindowEvent e) { // activate the window
                    jLabel2.setText(MainMenu.cases[7].getCaseTitle()); // set the text as the case title
                    jLabel4.setText(MainMenu.cases[7].getCategory()); // set the text as the case category
                    jTextArea2.setText(MainMenu.cases[7].getCaseDescription()); // set the text as the case description
                } // close
            }); // close
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new Info().setVisible(true); // make the next frame visible
