...
public class Scenario7 extends javax.swing.JFrame {
        ...
        jTextArea2.setWrapStyleWord(true);
            ...
            addWindowListener(new WindowAdapter() {
                ...
                public void windowActivated(WindowEvent e) {
                    ...
                    jTextArea2.setText(MainMenu.cases[6].getCaseDescription());
                }
            });
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        MainMenu.cases[6].verdict.setCaseName(jLabel2.getText());
        MainMenu.cases[6].verdict.setReason(jTextArea1.getText());
        if (jRadioButton1.isSelected()) {
            MainMenu.cases[6].verdict.setStudentVerdict(Verdict.ethical);
            MainMenu.ethical +=1;
        } else if (jRadioButton2.isSelected()) {
            MainMenu.cases[6].verdict.setStudentVerdict(Verdict.unethical);
