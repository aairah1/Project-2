 ...
 * @author 345730287
 */
public class Scenario5 extends javax.swing.JFrame { // scenario5 class extends jframe
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jRadioButton1.isSelected()) { // if the first radio button is selected
            MainMenu.cases[4].verdict.setStudentVerdict(MainMenu.Sethical); // set the case 4 verdict to be ethical
            ...
            MainMenu.cases[4].verdict.setStudentVerdict(MainMenu.Sunethical); // set the case 4 verdict to be unethical
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Scenario5().setVisible(true); //make this page visible
            }
        });
    }
