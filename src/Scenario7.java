 ...
 * @author 345730287
 */
public class Scenario7 extends javax.swing.JFrame { // scenario7 class extends jframe

    /**
     * Creates new form Scenario7
     */
    public Scenario7() { // Scenario7 constructor
        ...
        jTextArea2.setWrapStyleWord(true); // make the wrap style true
            ...
            addWindowListener(new WindowAdapter() { // add Window Listener
                ...
                public void windowActivated(WindowEvent e) { // activate the window
                    jLabel2.setText(MainMenu.cases[6].getCaseTitle()); // set the text as the case title
                    jLabel4.setText(MainMenu.cases[6].getCategory()); // set the text as the case category
                    jTextArea2.setText(MainMenu.cases[6].getCaseDescription()); // set the text as the case description
                } // close
            }); // close
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        MainMenu.cases[6].verdict.setCaseName(jLabel2.getText()); // set the case 6 array verdict case name as the text in jLabel2
        MainMenu.cases[6].verdict.setReason(jTextArea1.getText()); // set the case 6 array cerdict case reason as the text area
        if (jRadioButton1.isSelected()) { // if the first radio button is selected
            MainMenu.cases[6].verdict.setStudentVerdict(MainMenu.Sethical); // set the case 6 verdict to be ethical
            ...
            MainMenu.cases[6].verdict.setStudentVerdict(MainMenu.Sunethical); // set the case 6 verdict to be unethical
            MainMenu.unethical += 1; // increment the unethical counter by 1
        } // end the if statements
        
        new Scenario8().setVisible(true); // make the next frame visible
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Scenario7().setVisible(true); // make this page visible
            }
        });
    }
